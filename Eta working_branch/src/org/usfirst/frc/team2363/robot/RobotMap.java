...
public class RobotMap {
	...
	public static final int DOC_OC_OPEN = 8; //r trigger
	public static final int DOC_OC_CLOSE = 7; //l trigger
	public static final int CLOSE_BEAR_HUGGER = 6; //r bumper
	public static final int OPEN_BEAR_HUGGER = 5; //l bumper
	public static final int BEAR_HUGGER_UP = 4; //triangle
	public static final int BEAR_HUGGER_DOWN = 2;//x
